...
<body>
    <div class="container">
        ...
        <p class="allowed-types">Allowed formats: PY, SH, ZIP, RAR</p>
        ...
        if(isset($_POST["submit"])) {
            if(isset($_FILES["fileToUpload"]) && $_FILES["fileToUpload"]["error"] == 0) {
                ...
                $allowedTypes = array("py", "sh", "zip", "rar");
                
                if (!in_array($fileType, $allowedTypes)) {
                    echo "<div class='error'>Only PY, SH, ZIP, and RAR files are allowed.</div>";
                } else {
